...
urlpatterns = [
    ...
    path(
        "thread/<slug:category_slug>/<int:pk>/", views.thread_view, name="thread-view"
    ),
    path("create_thread/", views.create_thread, name="create-thread"),
    path(
        "thread/<slug:category_slug>/<int:pk>/reply/",
        views.create_reply,
        name="reply-thread",
    ),
    path(
        "thread/<slug:category_slug>/<int:pk>/reply/<int:parent_id>/",
        views.create_reply,
        name="reply-reply",
    ),
    ...
    path(
        "thread/<int:pk>/toggle-lock/",
        views.toggle_thread_lock,
        name="toggle-thread-lock",
    ),
